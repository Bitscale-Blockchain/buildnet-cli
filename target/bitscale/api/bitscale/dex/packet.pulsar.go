...
func init() {
	file_bitscale_dex_packet_proto_init()
	md_DexPacketData = File_bitscale_dex_packet_proto.Messages().ByName("DexPacketData")
...
func (x *DexPacketData) slowProtoReflect() protoreflect.Message {
	mi := &file_bitscale_dex_packet_proto_msgTypes[0]
...
func (x *fastReflection_DexPacketData) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "bitscale.dex.DexPacketData.noData":
		if x.Packet == nil {
			return false
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bitscale.dex.DexPacketData"))
		}
		panic(fmt.Errorf("message bitscale.dex.DexPacketData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_DexPacketData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bitscale.dex.DexPacketData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_DexPacketData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	case "bitscale.dex.DexPacketData.packet":
		if x.Packet == nil {
			return nil
		}
	...
	default:
		panic(fmt.Errorf("%s is not a oneof field in bitscale.dex.DexPacketData", d.FullName()))
	}
	panic("unreachable")
}
...
func init() {
	file_bitscale_dex_packet_proto_init()
	md_NoData = File_bitscale_dex_packet_proto.Messages().ByName("NoData")
}
...
func (x *NoData) slowProtoReflect() protoreflect.Message {
	mi := &file_bitscale_dex_packet_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
func (x *fastReflection_NoData) Has(fd protoreflect.FieldDescriptor) bool {
	...
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: bitscale.dex.NoData"))
		}
		panic(fmt.Errorf("message bitscale.dex.NoData does not contain field %s", fd.FullName()))
	}
}
...
func (x *fastReflection_NoData) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	...
	default:
		...
		panic(fmt.Errorf("message bitscale.dex.NoData does not contain field %s", descriptor.FullName()))
	}
}
...
func (x *fastReflection_NoData) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in bitscale.dex.NoData", d.FullName()))
	}
	panic("unreachable")
}
...
// 	protoc        (unknown)
// source: bitscale/dex/packet.proto
...
func (*DexPacketData) Descriptor() ([]byte, []int) {
	return file_bitscale_dex_packet_proto_rawDescGZIP(), []int{0}
}
...
func (*NoData) Descriptor() ([]byte, []int) {
	return file_bitscale_dex_packet_proto_rawDescGZIP(), []int{1}
}

var File_bitscale_dex_packet_proto protoreflect.FileDescriptor

var file_bitscale_dex_packet_proto_rawDesc = []byte{
	,
	...
	0x2f, 0x61, 0x70, 0x69, 0x2f, 0x62, 0x69, 0x74, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x2f, 0x64, 0x65,
	0x78, 0xa2, 0x02, 0x03, 0x42, 0x44, 0x58, 0xaa, 0x02, 0x0c, 0x42, 0x69, 0x74, 0x73, 0x63, 0x61,
	0x6c, 0x65, 0x2e, 0x44, 0x65, 0x78, 0xca, 0x02, 0x0c, 0x42, 0x69, 0x74, 0x73, 0x63, 0x61, 0x6c,
	0x65, 0x5c, 0x44, 0x65, 0x78, 0xe2, 0x02, 0x18, 0x42, 0x69, 0x74, 0x73, 0x63, 0x61, 0x6c, 0x65,
	0x5c, 0x44, 0x65, 0x78, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61,
	0xea, 0x02, 0x0d, 0x42, 0x69, 0x74, 0x73, 0x63, 0x61, 0x6c, 0x65, 0x3a, 0x3a, 0x44, 0x65, 0x78,
	0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_bitscale_dex_packet_proto_rawDescOnce sync.Once
	file_bitscale_dex_packet_proto_rawDescData = file_bitscale_dex_packet_proto_rawDesc
)

func file_bitscale_dex_packet_proto_rawDescGZIP() []byte {
	file_bitscale_dex_packet_proto_rawDescOnce.Do(func() {
		file_bitscale_dex_packet_proto_rawDescData = protoimpl.X.CompressGZIP(file_bitscale_dex_packet_proto_rawDescData)
	})
	return file_bitscale_dex_packet_proto_rawDescData
}

var file_bitscale_dex_packet_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_bitscale_dex_packet_proto_goTypes = []interface{}{
	(*DexPacketData)(nil), // 0: bitscale.dex.DexPacketData
	(*NoData)(nil),        // 1: bitscale.dex.NoData
}
var file_bitscale_dex_packet_proto_depIdxs = []int32{
	1, // 0: bitscale.dex.DexPacketData.noData:type_name -> bitscale.dex.NoData
...
func init() { file_bitscale_dex_packet_proto_init() }
func file_bitscale_dex_packet_proto_init() {
	if File_bitscale_dex_packet_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_bitscale_dex_packet_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_bitscale_dex_packet_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*NoData); i {
			case 0:
				return &v.state
			case 1:
	...
	file_bitscale_dex_packet_proto_msgTypes[0].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_bitscale_dex_packet_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_bitscale_dex_packet_proto_goTypes,
		DependencyIndexes: file_bitscale_dex_packet_proto_depIdxs,
		MessageInfos:      file_bitscale_dex_packet_proto_msgTypes,
	}.Build()
	File_bitscale_dex_packet_proto = out.File
	file_bitscale_dex_packet_proto_rawDesc = nil
	file_bitscale_dex_packet_proto_goTypes = nil
	file_bitscale_dex_packet_proto_depIdxs = nil
}
